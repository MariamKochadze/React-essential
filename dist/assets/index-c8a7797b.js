...
var Xu = {
    ...
    Gu = {};
function lt(e, n, t) {
    (this.props = e), (this.context = n), (this.refs = Gu), (this.updater = t || Xu);
}
...
function bu(e, n, t) {
    ...
    return { $$typeof: Xt, type: e, key: o, ref: i, props: l, _owner: Ho.current };
}
function hc(e, n) {
            ...
            Fi(l)
                ...
                : l != null &&
                  (Bo(l) &&
                      (l = hc(
                          l,
                          t + (!l.key || (i && i.key === l.key) ? '' : ('' + l.key).replace(Ui, '$&/') + '/') + e
                      )),
                  n.push(l)),
            1
        );
...
var ue = { current: null },
    wr = { transition: null },
    gc = { ReactCurrentDispatcher: ue, ReactCurrentBatchConfig: wr, ReactCurrentOwner: Ho };
function es() {
 ...
 */ (function (e) {
            ...
            e: for (var W = 0, G = x.length, qt = G >>> 1; W < qt; ) {
                ...
                if (0 > l(gl, T))
                    yn < G && 0 > l(bt, gl)
                        ? ((x[W] = bt), (x[yn] = T), (W = yn))
                        : ((x[W] = gl), (x[vn] = T), (W = vn));
                else if (yn < G && 0 > l(bt, T)) (x[W] = bt), (x[yn] = T), (W = yn);
                else break e;
            }
        }
        return N;
    ...
    (e.unstable_IdlePriority = 5),
        ...
        (e.unstable_scheduleCallback = function (x, N, T) {
            ...
            return (
                (G = T + G),
                (x = { id: h++, callback: N, priorityLevel: x, startTime: T, expirationTime: G, sortIndex: -1 }),
                T > W
                    ? ((x.sortIndex = T),
                      n(c, x),
                      t(s) === null && x === t(c) && (S ? (f(P), (P = -1)) : (S = !0), yl(v, T - W)))
...
function Jn(e, n) {
    for (Lt[e] = n, e = 0; e < n.length; e++) os.add(n[e]);
}
var We = !(typeof window > 'u' || typeof window.document > 'u' || typeof window.document.createElement > 'u'),
    ...
    Vi = {};
function zc(e) {
    return Xl.call(Vi, e) ? !0 : Xl.call($i, e) ? !1 : Nc.test(e) ? (Vi[e] = !0) : (($i[e] = !0), !1);
}
function Tc(e, n, t, r) {
...
function gs() {
    if (Kn) {
        var e = Kn,
            n = Xn;
        if (((Xn = Kn = null), Ki(e), n)) for (e = 0; e < n.length; e++) Ki(n[e]);
    }
}
function ws(e, n) {
    return e(n);
...
function Uc(e, n, t, r, l, o, i, u, s) {
    (Et = !1), (Rr = null), Dc.apply(Fc, arguments);
}
...
function bc(e, n, t, r, l) {
    switch (n) {
        ...
        case 'gotpointercapture':
            return (o = l.pointerId), Mt.set(o, ft(Mt.get(o) || null, e, n, t, r, l)), !0;
    }
    return !1;
}
function Ms(e) {
...
function Sr(e) {
    ...
    for (var n = e.targetContainers; 0 < n.length; ) {
        ...
        } else return (n = Zt(t)), n !== null && ei(n), (e.blockedOn = t), !1;
        n.shift();
    }
    return !0;
}
...
function dt(e, n) {
    e.blockedOn === n &&
        ((e.blockedOn = null), co || ((co = !0), ye.unstable_scheduleCallback(ye.unstable_NormalPriority, ef)));
}
function It(e) {
    function n(l) {
        return dt(l, e);
    ...
    for (; 0 < qe.length && ((t = qe[0]), t.blockedOn === null); ) Ms(t), t.blockedOn === null && qe.shift();
}
...
function ni(e, n, t, r) {
    if (Ir) {
        var l = fo(e, n, t, r);
        if (l === null) Ml(e, n, r, Dr, t), Gi(e, r);
        else if (bc(l, e, n, t, r)) r.stopPropagation();
        else if ((Gi(e, r), n & 4 && -1 < qc.indexOf(e))) {
            for (; l !== null; ) {
                var o = Zt(l);
                if ((o !== null && Ls(o), (o = fo(e, n, t, r)), o === null && Ml(e, n, r, Dr, t), o === l)) break;
                l = o;
            }
...
var Dr = null;
function fo(e, n, t, r) {
    if (((Dr = null), (e = Jo(r)), (e = Sn(e)), e !== null))
...
function Tf(e, n) {
    if (In)
        return e === 'compositionend' || (!oi && Us(e, n)) ? ((e = Ds()), (kr = ti = en = null), (In = !1), e) : null;
    switch (e) {
        case 'paste':
            return null;
        case 'keypress':
...
function Vs(e, n, t, r) {
    ys(r),
        (n = Fr(n, 'onChange')),
        0 < n.length && ((t = new ri('onChange', 'change', null, t, r)), e.push({ event: t, listeners: n }));
}
var Ct = null,
    Dt = null;
function Rf(e) {
...
function ou() {
    Ct && (Ct.detachEvent('onpropertychange', Hs), (Dt = Ct = null));
}
function Hs(e) {
    if (e.propertyName === 'value' && rl(Dt)) {
        var n = [];
        Vs(n, Dt, e, Jo(e)), ks(Rf, n);
    }
}
function Of(e, n, t) {
    e === 'focusin' ? (ou(), (Ct = n), (Dt = t), Ct.attachEvent('onpropertychange', Hs)) : e === 'focusout' && ou();
}
function Mf(e) {
...
function su(e, n, t) {
    ...
    mo ||
        ...
        (_t && Ft(_t, r)) ||
            ...
            (r = Fr(po, 'onSelect')),
            0 < r.length &&
                ((n = new ri('onSelect', 'select', null, n, t)), e.push({ event: n, listeners: r }), (n.target = Dn))));
}
function sr(e, n) {
    var t = {};
...
for (var Rl = 0; Rl < au.length; Rl++) {
    var jl = au[Rl],
        Vf = jl.toLowerCase(),
        Af = jl[0].toUpperCase() + jl.slice(1);
    pn(Vf, 'on' + Af);
}
            ...
            if (p !== void 0) {
                ...
                for (var a = c, d; a !== null; ) {
                    ...
                    if (
                        (d.tag === 5 &&
                            v !== null &&
                            ((d = v), f !== null && ((v = jt(a, f)), v != null && S.push($t(a, v, d)))),
                        F)
                    )
                        break;
                    a = a.return;
        ...
        if (!(n & 7)) {
            e: {
                if (
                    ...
                    p && t !== oo && (w = t.relatedTarget || t.fromElement) && (Sn(w) || w[Qe]))
                )
                    break e;
                if (
                    (g || p) &&
                    ...
                    g
                        ? ((w = t.relatedTarget || t.toElement),
                          (g = c),
                          (w = w ? Sn(w) : null),
                          w !== null && ((F = Rn(w)), w !== F || (w.tag !== 5 && w.tag !== 6)) && (w = null))
                        : ((g = null), (w = c)),
                    g !== w)
                ) {
                    if (
                        ...
                        (e === 'pointerout' || e === 'pointerover') &&
                            ((S = eu), (v = 'onPointerLeave'), (f = 'onPointerEnter'), (a = 'pointer')),
                        (F = g == null ? p : Un(g)),
                        (d = w == null ? p : Un(w)),
                        ...
                        (v = null),
                        Sn(h) === c &&
                            ((S = new S(f, a + 'enter', w, t, h)), (S.target = d), (S.relatedTarget = F), (v = S)),
                        (F = v),
                        g && w)
                    )
                        n: {
                    ...
                    g !== null && fu(m, p, g, S, !1), w !== null && F !== null && fu(m, F, w, S, !0);
                }
            }
            e: {
                if (
            ...
            switch (((C = c ? Un(c) : window), e)) {
                case 'focusin':
                    (ru(C) || C.contentEditable === 'true') && ((Dn = C), (po = c), (_t = null));
                    break;
                case 'focusout':
                    _t = po = Dn = null;
                    break;
            ...
            P &&
                (Fs &&
                    ...
                    (In || P !== 'onCompositionStart'
                        ? P === 'onCompositionEnd' && In && (_ = Ds())
                        : ((en = h), (ti = 'value' in en ? en.value : en.textContent), (In = !0))),
                (C = Fr(c, P)),
                0 < C.length &&
...
function fu(e, n, t, r, l) {
    for (var o = n._reactName, i = []; t !== null && t !== r; ) {
        ...
        u.tag === 5 &&
            ...
            ((u = c),
            l
                ? ((s = jt(t, o)), s != null && i.unshift($t(t, s, u)))
                : l || ((s = jt(t, o)), s != null && i.push($t(t, s, u)))),
            (t = t.return);
    }
...
var go = typeof setTimeout == 'function' ? setTimeout : void 0,
    ...
    Kf =
        typeof queueMicrotask == 'function'
            ...
            : typeof pu < 'u'
            ? function (e) {
                  return pu.resolve(null).then(e).catch(Xf);
              }
            : go;
function Xf(e) {
    setTimeout(function () {
...
function vu(e, n, t) {
    ...
    t ? ((e = bs(e, n, _n)), (r.__reactInternalMemoizedMergedChildContext = e), D(fe), D(le), M(le, e)) : D(fe),
        M(fe, t);
}
var Ve = null,
    il = !1,
...
function hn() {
    if (!Dl && Ve !== null) {
        ...
        try {
            ...
            throw (Ve !== null && (Ve = Ve.slice(e + 1)), _s(qo, hn), l);
        } finally {
            (O = n), (Dl = !1);
        }
    }
...
function si(e) {
    ...
    for (; e === Pn; )
        (Pn = Se[--ke]), (Se[ke] = null), (He = Se[--ke]), (Se[ke] = null), (Ae = Se[--ke]), (Se[ke] = null);
}
var ve = null,
    he = null,
    U = !1,
    ...
    if (U) {
        ...
        if (n) {
            ...
            if (!yu(e, n)) {
                ...
                n = on(t.nextSibling);
                var r = ve;
                n && yu(e, n) ? ta(r, t) : ((e.flags = (e.flags & -4097) | 2), (U = !1), (ve = e));
            }
        } else {
            if (ko(e)) throw Error(y(418));
...
function fr(e) {
    ...
    if (
        ((n = e.tag !== 3) &&
            !(n = e.tag !== 5) &&
            ((n = e.type), (n = n !== 'head' && n !== 'body' && !yo(e.type, e.memoizedProps))),
        n && (n = he))
    ) {
...
function la(e) {
    ...
    function s(f, a, d, v) {
        ...
        return E === Mn
            ...
            : a !== null &&
              (a.elementType === E || (typeof E == 'object' && E !== null && E.$$typeof === Ze && wu(E) === a.type))
            ? ((v = l(a, d.props)), (v.ref = mt(f, a, d)), (v.return = f), v)
            : ((v = Tr(d.type, d.key, d.props, null, f.mode, v)), (v.ref = mt(f, a, d)), (v.return = f), v);
    }
    function c(f, a, d, v) {
        return a === null ||
            a.tag !== 4 ||
    ...
    function m(f, a, d) {
        ...
        if (typeof a == 'object' && a !== null) {
            switch (a.$$typeof) {
                case nr:
                    return (
                        (d = Tr(a.type, a.key, a.props, null, f.mode, d)), (d.ref = mt(f, null, a)), (d.return = f), d
                    );
                case On:
    ...
    function S(f, a, d, v) {
        ...
        for (var C = (E = null), _ = a, P = (a = 0), B = null, R = d.next(); _ !== null && !R.done; P++, R = d.next()) {
            _.index > P ? ((B = _), (_ = null)) : (B = _.sibling);
        ...
        if (R.done) return t(f, _), U && gn(f, P), E;
        if (_ === null) {
            for (; !R.done; P++, R = d.next())
                (R = m(f, R.value, v)),
                    R !== null && ((a = o(R, a, P)), C === null ? (E = R) : (C.sibling = R), (C = R));
            return U && gn(f, P), E;
        }
            ...
            switch (d.$$typeof) {
                case nr:
                    e: {
                        for (var E = d.key, C = a; C !== null; ) {
                            if (C.key === E) {
                                if (((E = d.type), E === Mn)) {
                                    ...
                                    C.elementType === E ||
                                    (typeof E == 'object' && E !== null && E.$$typeof === Ze && wu(E) === C.type)
                                ) {
                                    t(f, C.sibling),
                                        (a = l(C, d.props)),
                                        (a.ref = mt(f, C, d)),
                        ...
                        d.type === Mn
                            ? ((a = Cn(d.props.children, f.mode, v, d.key)), (a.return = f), (f = a))
...
function ia(e, n, t, r) {
    var l = n.interleaved;
    return l === null ? ((t.next = t), pi(n)) : ((t.next = l.next), (l.next = t)), (n.interleaved = t), Ke(e, r);
}
function Ke(e, n) {
    e.lanes |= n;
    var t = e.alternate;
...
function hi(e, n) {
    switch ((M(Ht, n), M(At, e), M(Ue, Jt), (e = n.nodeType), e)) {
        case 9:
        case 11:
...
function wi(e, n, t, r, l, o) {
    if (
        ...
        do {
            ...
            (o += 1), (Z = X = null), (n.updateQueue = null), (Cr.current = ld), (e = t(r, l));
        } while (Pt);
    }
    if (((Cr.current = Yr), (n = X !== null && X.next !== null), (Nn = 0), (Z = X = V = null), (Xr = !1), n))
        throw Error(y(300));
    return e;
}
function Si() {
    ...
    if (l !== null) {
        ...
        do {
            ...
            if ((Nn & h) === h)
                ...
                s === null ? ((u = s = m), (i = r)) : (s = s.next = m), (V.lanes |= h), (zn |= h);
            }
            c = c.next;
        } while (c !== null && c !== o);
        s === null ? (i = r) : (s.next = u),
...
function ca(e, n) {
    ...
    if (
        ...
        if (((t.flags |= 2048), Qt(9, da.bind(null, t, r, l, n), void 0, null), J === null)) throw Error(y(349));
        Nn & 30 || fa(t, n, l);
    }
    return l;
}
...
function xa(e, n, t) {
    return Nn & 21
        ? (Oe(t, n) || ((t = zs()), (V.lanes |= t), (zn |= t), (e.baseState = !0)), n)
...
function ed(e, n, t) {
    var r = an(e);
    if (((t = { lane: r, action: t, hasEagerState: !1, eagerState: null, next: null }), _a(e))) Pa(n, t);
        ...
        if (e.lanes === 0 && (o === null || o.lanes === 0) && ((o = n.lastRenderedReducer), o !== null))
            try {
                ...
                if (((l.hasEagerState = !0), (l.eagerState = u), Oe(u, i))) {
                    var s = n.interleaved;
                    s === null ? ((l.next = l), pi(n)) : ((l.next = s.next), (s.next = l)), (n.interleaved = l);
                    return;
                }
            } catch {
            } finally {
            }
        (t = ia(e, n, l, r)), t !== null && ((l = ie()), je(t, e, r, l), Na(t, n, r));
    }
}
function _a(e) {
    var n = e.alternate;
...
var Yr = {
    ...
    ld = {
        ...
        useDeferredValue: function (e) {
            var n = _e();
            return X === null ? (n.memoizedState = e) : xa(n, X.memoizedState, e);
        },
        useTransition: function () {
            var e = Vl(Wt)[0],
                n = _e().memoizedState;
...
var sl = {
    ...
    enqueueSetState: function (e, n, t) {
        ...
        var r = ie(),
            l = an(e),
            o = Be(r, l);
        (o.payload = n), t != null && (o.callback = t), (n = un(e, o, l)), n !== null && (je(n, e, l, r), xr(n, e, l));
    },
    ...
    enqueueForceUpdate: function (e, n) {
        ...
        var t = ie(),
            r = an(e),
            l = Be(t, r);
        (l.tag = 2), n != null && (l.callback = n), (n = un(e, l, r)), n !== null && (je(n, e, r, t), xr(n, e, r));
    },
};
...
function za(e, n, t) {
    ...
    return (
        typeof o == 'object' && o !== null
            ? (o = Ce(o))
            : ((l = de(n) ? _n : le.current), (r = n.contextTypes), (o = (r = r != null) ? qn(e, l) : dn)),
        (n = new n(t, o)),
...
function _o(e, n, t, r) {
    ...
    var o = n.contextType;
    typeof o == 'object' && o !== null ? (l.context = Ce(o)) : ((o = de(n) ? _n : le.current), (l.context = qn(e, o))),
...
function La(e, n, t) {
    ...
    return (
        o !== null &&
            ...
            (t.callback = function () {
                Po(e, n), typeof r != 'function' && (sn === null ? (sn = new Set([this])) : sn.add(this));
                var i = n.stack;
...
function Lu(e, n, t, r, l) {
    ...
    if (((o = e.child), !(e.lanes & l))) {
        ...
        if (((t = t.compare), (t = t !== null ? t : Ft), t(i, r) && e.ref === n.ref)) return Xe(e, n, l);
    }
...
function Ru(e, n, t, r, l) {
    ...
    if ((Gn(n, l), n.stateNode === null)) Pr(e, n), za(n, t, r), _o(n, t, r, l), (r = !0);
    else if (e === null) {
        var i = n.stateNode,
            u = n.memoizedProps;
        i.props = u;
        var s = i.context,
            c = t.contextType;
        typeof c == 'object' && c !== null ? (c = Ce(c)) : ((c = de(t) ? _n : le.current), (c = qn(n, c)));
        ...
        (i = n.stateNode),
            ...
            (p = i.context),
            (s = t.contextType),
            typeof s == 'object' && s !== null ? (s = Ce(s)) : ((s = de(t) ? _n : le.current), (s = qn(n, s)));
...
function zo(e, n, t, r, l, o) {
    ...
    return (
        (n.flags |= 1),
        e !== null && i ? ((n.child = et(n, e.child, null, o)), (n.child = et(n, null, u, o))) : oe(e, n, u, o),
...
function ud(e, n, t, r, l, o, i) {
    ...
    if (((u = (i & e.childLanes) !== 0), ce || u)) {
        ...
        return Ti(), (r = Al(Error(y(421)))), pr(e, n, i, r);
    }
    return l.data === '$?'
        ...
        : ((e = o.treeContext),
          ...
          (U = !0),
          (Le = null),
          e !== null && ((Se[ke++] = Ae), (Se[ke++] = He), (Se[ke++] = Pn), (Ae = e.id), (He = e.overflow), (Pn = n)),
          (n = xi(n, r.children)),
          (n.flags |= 4096),
          n);
}
        ...
        case 13:
            if (((r = n.memoizedState), r !== null))
                return r.dehydrated !== null
                    ...
                    ? Ia(e, n, t)
                    : (M($, $.current & 1), (e = Xe(e, n, t)), e !== null ? e.sibling : null);
            M($, $.current & 1);
            break;
        case 19:
            ...
            if (!r.hasOwnProperty(c) && l.hasOwnProperty(c) && l[c] != null)
                if (c === 'style') {
                    ...
                    c !== 'dangerouslySetInnerHTML' &&
                        ...
                        c !== 'autoFocus' &&
                        (Lt.hasOwnProperty(c) ? o || (o = []) : (o = o || []).push(c, null));
        for (c in r) {
            var s = r[c];
                ...
                if (c === 'style')
                    ...
                    c === 'dangerouslySetInnerHTML'
                        ...
                        : c !== 'suppressContentEditableWarning' &&
                          c !== 'suppressHydrationWarning' &&
                          (Lt.hasOwnProperty(c)
                              ? (s != null && c === 'onScroll' && I('scroll', e), o || u === s || (o = []))
                              : (o = o || []).push(c, s));
        }
        t && (o = o || []).push('style', t);
        var c = o;
    ...
    switch ((si(n), n.tag)) {
                    ...
                    for (var i in o)
                        if (o.hasOwnProperty(i)) {
                            ...
                            i === 'children'
                                ? typeof u == 'string'
                                    ? r.textContent !== u &&
                                      (o.suppressHydrationWarning !== !0 && cr(r.textContent, u, e),
                                      (l = ['children', u]))
                                    : typeof u == 'number' &&
                                      r.textContent !== '' + u &&
                                      (o.suppressHydrationWarning !== !0 && cr(r.textContent, u, e),
                                      (l = ['children', '' + u]))
                                : Lt.hasOwnProperty(i) && u != null && i === 'onScroll' && I('scroll', r);
                        }
                    switch (t) {
                        case 'input':
                            tr(r), Bi(r, o, !0);
        ...
        case 13:
            if (
                ...
                if (U && he !== null && n.mode & 1 && !(n.flags & 128)) ra(), bn(), (n.flags |= 98560), (o = !1);
            ...
            return n.flags & 128
                ...
                : ((r = r !== null),
                  r !== (e !== null && e.memoizedState !== null) &&
                      r &&
                      ((n.child.flags |= 8192),
                      n.mode & 1 && (e === null || $.current & 1 ? Y === 0 && (Y = 3) : Ti())),
                  n.updateQueue !== null && (n.flags |= 4),
                  te(n),
                  null);
        case 4:
            return nt(), Ro(e, n), e === null && Ut(n.stateNode.containerInfo), te(n), null;
        case 10:
...
function Va(e) {
    ...
    n !== null && ((e.alternate = null), Va(n)),
        ...
        (e.sibling = null),
        e.tag === 5 &&
            ((n = e.stateNode), n !== null && (delete n[De], delete n[Vt], delete n[wo], delete n[Yf], delete n[Gf])),
        (e.stateNode = null),
        (e.return = null),
        (e.dependencies = null),
...
function Ha(e, n, t) {
    ...
    switch (t.tag) {
        ...
        case 15:
            ...
            break;
        case 1:
            if (!re && (Bn(t, n), (r = t.stateNode), typeof r.componentWillUnmount == 'function'))
                try {
...
function Ba(e, n) {
    ...
    switch (e.tag) {
        ...
        case 1:
            ...
            break;
        case 5:
            if ((Ne(n, e), Me(e), r & 512 && t !== null && Bn(t, t.return), e.flags & 32)) {
                var l = e.stateNode;
                try {
                    Rt(l, '');
                } catch (S) {
            ...
            if (r & 4 && ((l = e.stateNode), l != null)) {
                ...
                if (((e.updateQueue = null), s !== null))
                    try {
                        u === 'input' && o.type === 'radio' && o.name != null && fs(l, o), lo(u, i);
                        var c = lo(u, o);
...
function an(e) {
    return e.mode & 1
        ? j & 2 && b !== 0
            ...
            : Jf.transition !== null
            ? (zr === 0 && (zr = zs()), zr)
            : ((e = O), e !== 0 || ((e = window.event), (e = e === void 0 ? 16 : Is(e.type))), e)
        : 1;
}
function je(e, n, t, r) {
    ...
    Yt(e, t, r),
        (!(j & 2) || e !== J) &&
            (e === J && (!(j & 2) && (cl |= t), Y === 4 && be(e, b)),
            pe(e, r),
            t === 1 && j === 0 && !(n.mode & 1) && ((rt = Q() + 500), il && hn()));
}
function pe(e, n) {
    ...
    if (r === 0) t !== null && Yi(t), (e.callbackNode = null), (e.callbackPriority = 0);
        ...
        if ((t != null && Yi(t), n === 1))
            e.tag === 0 ? Zf(Vu.bind(null, e)) : ea(Vu.bind(null, e)),
                Kf(function () {
                    !(j & 6) && hn();
                }),
                (t = null);
...
function Qa(e, n) {
    if (((Nr = -1), (zr = 0), j & 6)) throw Error(y(327));
    var t = e.callbackNode;
    ...
    if (r & 30 || r & e.expiredLanes || n) n = qr(e, r);
        ...
        while (1);
        fi(), (Gr.current = o), (j = l), K !== null ? (n = 0) : ((J = null), (b = 0), (n = Y));
    }
    if (n !== 0) {
        ...
        if (n === 6) be(e, r);
            ...
            if (
                ...
                !(r & 30) &&
                    !hd(l) &&
                    ((n = qr(e, r)), n === 2 && ((o = ao(e)), o !== 0 && ((r = o), (n = Uo(e, o)))), n === 1))
            )
                throw ((t = Kt), xn(e, 0), be(e, r), pe(e, Q()), t);
            switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    if ((be(e, r), (r & 130023424) === r && ((n = Pi + 500 - Q()), 10 < n))) {
                        if (Mr(e, 0) !== 0) break;
...
function be(e, n) {
    for (n &= ~_i, n &= ~cl, e.suspendedLanes |= n, e.pingedLanes &= ~n, e = e.expirationTimes; 0 < n; ) {
        var t = 31 - Re(n),
            r = 1 << t;
        (e[t] = -1), (n &= ~r);
    }
...
function Ni(e, n) {
    ...
    try {
        ...
        (j = t), j === 0 && ((rt = Q() + 500), il && hn());
    }
}
function Tn(e) {
    nn !== null && nn.tag === 0 && !(j & 6) && Zn();
    var n = j;
    j |= 1;
    var t = xe.transition,
        r = O;
    try {
        ...
        (O = r), (xe.transition = t), (j = n), !(j & 6) && hn();
    }
}
function zi() {
    (me = Wn.current), D(Wn);
        ...
        try {
            ...
            e: {
                ...
                if (((n = b), (u.flags |= 32768), s !== null && typeof s == 'object' && typeof s.then == 'function')) {
                    ...
                    var g = Nu(i);
                    if (g !== null) {
                        (g.flags &= -257), zu(g, i, u, o, n), g.mode & 1 && Pu(o, c, n), (n = g), (s = c);
                        var w = n.updateQueue;
                        if (w === null) {
                            var S = new Set();
                    ...
                    var F = Nu(i);
                    if (F !== null) {
                        !(F.flags & 65536) && (F.flags |= 256), zu(F, i, u, o, n), ai(tt(s, u));
                        break e;
                    }
                }
...
function Ti() {
    (Y === 0 || Y === 3 || Y === 2) && (Y = 4), J === null || (!(zn & 268435455) && !(cl & 268435455)) || be(J, b);
}
function qr(e, n) {
    var t = j;
    j |= 2;
    ...
    while (1);
    if ((fi(), (j = t), (Gr.current = r), K !== null)) throw Error(y(261));
    return (J = null), (b = 0), Y;
}
function vd() {
    for (; K !== null; ) Ya(K);
...
function Ya(e) {
    ...
    (e.memoizedProps = e.pendingProps), n === null ? Ga(e) : (K = n), (Ci.current = null);
}
function Ga(e) {
    var n = e;
    do {
...
function Zn() {
    if (nn !== null) {
        var e = Ts(Jr),
            ...
            t = O;
        try {
            if (((xe.transition = null), (O = 16 > e ? 16 : e), nn === null)) var r = !1;
            else {
                if (((e = nn), (nn = null), (Jr = 0), j & 6)) throw Error(y(331));
                var l = j;
                ...
                if (((j = l), hn(), Fe && typeof Fe.onPostCommitFiberRoot == 'function'))
                    try {
...
function Au(e, n, t) {
    (n = tt(t, n)), (n = Ta(e, n, 1)), (e = un(e, n, 1)), (n = ie()), e !== null && (Yt(e, 1, n), pe(e, n));
}
function H(e, n, t) {
    if (e.tag === 3) Au(e, e, t);
    else
...
function wd(e, n, t) {
    ...
    r !== null && r.delete(n),
        ...
        J === e &&
            (b & t) === t &&
            (Y === 4 || (Y === 3 && (b & 130023424) === b && 500 > Q() - Pi) ? xn(e, 0) : (_i |= t)),
        pe(e, n);
}
function Za(e, n) {
    ...
    switch (((n.lanes = 0), n.tag)) {
        ...
        case 3:
            e: {
                ...
                (r = n.pendingProps), (o = n.memoizedState), (l = o.element), ua(e, n), Qr(n, r, null, t);
        ...
        case 14:
            return (r = n.type), (l = ze(r, n.pendingProps)), (l = ze(r.type, l)), Lu(e, n, r, l, t);
        case 15:
    ...
    switch (e.tag) {
        case 3:
            ...
            if (n.current.memoizedState.isDehydrated) {
                ...
                t !== 0 && (bo(n, t | 1), pe(n, Q()), !(j & 6) && ((rt = Q() + 500), hn()));
            }
            break;
        case 13:
            Tn(function () {
...
ws = Ni;
Ss = Tn;
var zd = { usingClientEntryPoint: !1, Events: [Zt, Un, ol, ys, gs, Ni] },
    vt = { findFiberByHostInstance: Sn, bundleType: 0, version: '18.3.1', rendererPackageName: 'react-dom' },
    Td = {
...
const Rd = './assets/react-core-concepts-26d0ae12.png';
const jd = ['Fundamental', 'Crucial', 'Core'];
function Od(e) {
...
function Md() {
    ...
    return z.jsxs('header', {
        children: [
            z.jsx('img', { src: Rd, alt: 'Stylized atom' }),
            z.jsx('h1', { children: 'React Essentials' }),
            z.jsxs('p', { children: [e, ' React concepts you will need for almost any app you are going to build!'] }),
        ],
    });
}
function Id({ image: e, title: n, description: t }) {
    return z.jsxs('li', {
        children: [z.jsx('img', { src: e, alt: n }), z.jsx('h3', { children: n }), z.jsx('p', { children: t })],
    });
}
const Dd = './assets/components-c877e0bc.png',
    Fd = './assets/config-85c304f7.png',
    Ud = './assets/jsx-ui-e8f9de9c.png',
    $d = './assets/state-mgmt-89bcf63f.png',
    Vd = [
        {
            image: Dd,
            title: 'Components',
...
function Ad() {
    return z.jsxs('section', {
        id: 'core-concepts',
        children: [
            z.jsx('h2', { children: 'Core Concepts' }),
            z.jsx('ul', { children: Vd.map((e) => z.jsx(Id, { ...e })) }),
        ],
    });
}
function yr({ children: e, isSelected: n, ...t }) {
    return z.jsx('li', { children: z.jsx('button', { className: n ? 'active' : void 0, ...t, children: e }) });
}
function Hd({ title: e, children: n, ...t }) {
    return z.jsxs('section', { ...t, children: [z.jsx('h2', { children: e }), n] });
}
function Bd({ children: e, buttons: n, Buttonscontainer: t = 'menu' }) {
    return z.jsxs(z.Fragment, { children: [z.jsx(t, { children: n }), e] });
}
function Wd() {
    const [e, n] = Wo.useState();
    function t(l) {
        n(l);
    }
    let r = z.jsx('p', { children: 'Please select a topic' });
    return (
        e &&
            (r = z.jsxs('div', {
                id: 'tab-content',
                children: [
                    z.jsx('h3', { children: Ql[e].title }),
                    z.jsx('p', { children: Ql[e].description }),
                    z.jsx('pre', { children: z.jsx('code', { children: Ql[e].code }) }),
                ],
            })),
        z.jsx(Hd, {
            title: 'Examples',
            ...
            children: z.jsx(Bd, {
                buttons: z.jsxs(z.Fragment, {
                    children: [
                        z.jsx(yr, {
                            isSelected: e === 'components',
                            onClick: () => t('components'),
                            children: 'Components',
                        }),
                        z.jsx(yr, { isSelected: e === 'jsx', onClick: () => t('jsx'), children: 'JSX' }),
                        z.jsx(yr, { isSelected: e === 'props', onClick: () => t('props'), children: 'Props' }),
                        z.jsx(yr, { isSelected: e === 'state', onClick: () => t('state'), children: 'State' }),
                    ],
                }),
                children: r,
            }),
...
function Qd() {
    return z.jsxs(z.Fragment, {
        children: [z.jsx(Md, {}), z.jsxs('main', { children: [z.jsx(Ad, {}), z.jsx(Wd, {})] })],
    });
}
const Kd = document.getElementById('root');
Kl.createRoot(Kd).render(z.jsx(Qd, {}));
